...
Run:
    ...
    .venv/bin/python -m messaging.gateway --no-imessage    # disable iMessage
    .venv/bin/python -m messaging.gateway --no-discord     # disable Discord
...
def main() -> int:
    ...
    if not args.no_imessage and sys.platform == "darwin":
        try:
            from messaging.imessage_bridge import IMessageBridge
