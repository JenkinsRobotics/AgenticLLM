...
def test_default_alias_is_two_pass() -> None:
    from python_jaeger.plugins.whisper_stt import WhisperSTT, WhisperSTTTwoPass
...
def test_both_modes_importable() -> None:
    ...
    from python_jaeger.plugins.whisper_stt import (
...
def test_shared_helpers() -> None:
    ...
    from python_jaeger.plugins.whisper_stt._base import (
