...
Run:
    python -m python_jaeger.plugins.voice_loop
    python -m python_jaeger.plugins.voice_loop --stt-mode continuous
    python -m python_jaeger.plugins.voice_loop --require-wake-word --barge-in
    python -m python_jaeger.plugins.voice_loop --instance work
